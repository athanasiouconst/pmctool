...
Class ModelsModel extends CI_Model {
    ...
    public function getViewComplexityFactor() {
        $query = $this->db->query("SELECT * FROM complexity_factor order by cf_id desc");
        $results = array();
        foreach ($query->result() as $row) {
            array_push($results, array(
                'cf_id' => $row->cf_id,
    ...
    //Delete
    function ModelsAssignmentsDelete($model_cf_id) {
        $this->db->where('model_cf_id', $model_cf_id);
        $this->db->delete('model_complex_factor');
    }

    public function getViewModelAssignFactor($model_cf_id) {
        $query = $this->db->query("SELECT * FROM model_complex_factor "
                . " LEFT JOIN model ON model_complex_factor.mod_id=model.mod_id"
                . " LEFT JOIN complexity_factor ON model_complex_factor.cf_id=complexity_factor.cf_id"
                . " LEFT JOIN metric ON complexity_factor.cf_id=metric.cf_id"
    ...
    function searchViewModelAssignFactor($model_cf_id) {
        //results
    ...
    public function getViewComplexityFactorAssignFactor($model_cf_id) {
        $query = $this->db->query("SELECT * FROM model_complex_factor "
                . " LEFT JOIN complexity_factor ON model_complex_factor.cf_id=complexity_factor.cf_id"
                . " WHERE model_complex_factor.model_cf_id='" . $model_cf_id . "' ");
        $results = array();
    ...
    function searchViewComplexityFactorAssignFactor($model_cf_id) {
    ...
    function searchViewComplexityFactorAssignFactor1() {
    ...
    public function getViewComplexityFactorAssignFactor1() {
    ...
    //Update 
    public function edit_ComplexityToModels($model_cf_id, $data) {

        $this->db->where('model_cf_id', $model_cf_id);
        $this->db->update('model_complex_factor', $data);
    }
