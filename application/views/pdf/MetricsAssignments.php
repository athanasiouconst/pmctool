...
$pdf->SetTitle('Metric Evaluation Scale');
$pdf->SetSubject('Metric Evaluation Scale');
$pdf->SetKeywords('PDF, Metric Evaluation Scale');
...
<table class="tg">
<tr>
    <td colspan="2" class="tg-pnx7" style=" text-align: center;"><h1>Evaluation Scale of Metric </h1></td>
</tr>
<tr>
  ...
  <tr>
    <td class="tg-saqj" ><h3>Evaluation Scale Title</h3></td>
...
// This method has several options, check the source code documentation for more information.
$pdf->Output('Metric Evaluation Scale_'.$today.'.pdf', 'I');
