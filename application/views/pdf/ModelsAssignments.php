...
$pdf->SetTitle('Model Assignments');
$pdf->SetSubject('Model Assignments');
$pdf->SetKeywords('PDF, Model Assignments');
...
<table class="tg">
<tr>
    <td colspan="2" class="tg-pnx7" style=" text-align: center;"><h1>Model</h1></td>
</tr>
<tr>
...
// This method has several options, check the source code documentation for more information.
$pdf->Output('Model Assignments_'.$today.'.pdf', 'I');
