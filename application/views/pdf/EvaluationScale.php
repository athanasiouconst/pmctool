...
$pdf->SetTitle('Evaluation Scale');
$pdf->SetSubject('Evaluation Scale');
$pdf->SetKeywords('PDF, Evaluation Scale');
...
<table class="tg">
<tr>
    <td colspan="2" class="tg-pnx7" style=" text-align: center;"><h1>Evaluation Scale </h1></td>
</tr>
<tr>
  ...
  <tr>
    <td class="tg-saqj"><h3>Type</h3></td>
    <td class="tg-saqj">' . $evsc_type . '</td>
  </tr>  
  <tr>
    <td class="tg-saqj"><h3>Number of Choices</h3></td>
...
// This method has several options, check the source code documentation for more information.
$pdf->Output('Evaluation Scale_'.$today.'.pdf', 'I');
