...
<body>
    ...
    <section class="metrics-section section-padding" id="metrics">
        <div class="container-fluid">
            ...
            <h2 class="section-title text-center">Assign Complexity Factors to Models</h2>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12 text-center ">
                    ...
                    <div class="align-left">
                        ...
                        <?php echo form_open('Models/ViewModelsAssignFactorEditSubmitForm') ?>  
                        <table class="table " style="width: 100%; alignment-adjust: auto; text-align:  left; font-size:16px; font-family: sans-serif;">
                            <?php if (isset($gModel)): ?>
                                <?php foreach ($genModel as $genModels): ?>
                                    <p><input type="hidden" size="80" id="model_cf_id" name="model_cf_id" value="<?php echo $genModels->model_cf_id; ?>"/>
                                    <?php endforeach; ?>
                                <?php endif; ?>  
                            <tr>
                                <td>
                            ...
                            <tr><td>Selected Complexity Factor (before update) :</td></tr>
                            <tr>
                                <td>
                                    <span title="Complexity Factor">
                                        ...
                                        <select  >
                                            ...
                                            <?php if (isset($gComplexityFactor)): ?>
                                                <?php foreach ($genComplexityFactor as $genComplexityFactor): ?>
                            ...
                            <tr><td>New Complexity Factor :</td></tr>
                            <tr>
                                <td>
                                    <span title="Complexity Factor">
                                        <label for="Complexity Factor"></label>
                                        <select name='cf_id' id='cf_id' >
                                            <option value="-1">New Complexity Factor</option>
                                            <?php if (isset($gComplexityFactor1)): ?>
                                                <?php foreach ($genComplexityFactor1 as $genComplexityFactor1): ?>
                                                    <option value="<?php echo $genComplexityFactor1->cf_id; ?>">
                                                        <?php echo $genComplexityFactor1->cf_name; ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                        </select>
